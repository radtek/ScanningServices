...
using System.ServiceModel;
 ...
 // sc \\HostName create VFRUploadMonitor binpath= ExcutableFullFilePath DisplayName= "SSS Auto Import"
namespace VFRUploadMonitor
{
    public partial class VFRUploadMonitorService : ServiceBase
    {
       
        private static NLog.Logger nlogger = LogManager.GetCurrentClassLogger();
        //public static string BaseURL = "http://localhost:47063" + "/api/";
        public static string BaseURL = VFRUploadMonitor.Properties.Settings.Default["APIEndPointURL"].ToString(); 
        public static int SleepTime = Convert.ToInt32(VFRUploadMonitor.Properties.Settings.Default["SleepTime"]);
        ...
        public VFRUploadMonitorService(string[] args)
        {
            InitializeComponent();
        }
        ...
        protected override void OnStart(string[] args)
        {
            try
            {
                ...
                VFRUploadMonitor.Program.RunMultipleJobs().GetAwaiter().GetResult();
            }
