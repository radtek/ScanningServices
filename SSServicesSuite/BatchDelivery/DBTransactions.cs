...
namespace BatchDelivery
{
    class DBTransactions
    {
        ...
        public static ResultJobsExtended GetJobs()
        {
            ...
            try
            {
                lock (lockObj)
                {
                    ...
                    URL = BatchDeliveryService.BaseURL + "Jobs/GetJobs";
        ...
        public static ResultServiceStationsExtended GetServiceStations()
        {
            ...
            try
            {
                lock (lockObj)
                {
                    ...
                    HttpClient client = new HttpClient();
                    client.Timeout = TimeSpan.FromMinutes(15);
                    URL = BatchDeliveryService.BaseURL + "GeneralSettings/GetServiceStations";
        ...
        public static ResultJobsExtended GetJobByID(int jobID)
        {
            ...
            try
            {
                lock (lockObj)
                {
                    ...
                    HttpClient client = new HttpClient();
                    client.Timeout = TimeSpan.FromMinutes(15);
                    URL = BatchDeliveryService.BaseURL + "Jobs/GetJobByID?jobID=" + jobID.ToString();
        ...
        public static ResultProcesses GetProcessByName(string processName)
        {
            ...
            try
            {
                lock (lockObj)
                {
                    ...
                    HttpClient client = new HttpClient();
                    client.Timeout = TimeSpan.FromMinutes(15);
                    URL = BatchDeliveryService.BaseURL + "Process/GetProcessesByName?processName=" + processName;
        ...
        public static ResultBatches GetBatchesbyJobType(string logJobName, string jobType)
        {
            ...
            try
            {
                lock (lockObj)
                {
                    ...
                    URL = BatchDeliveryService.BaseURL + "Batches/GetBatchesInformation?filter=" + "JobType = \"" + jobType + "\"";
        ...
        public static ResultBatches GetBatchesbyName(string logJobName, string batchNumber)
        {
            ResultBatches resultBatches = new ResultBatches();
            resultBatches.ReturnCode = 0;
            resultBatches.Message = "";
            ...
            try
            {
                lock (lockObj)
                {
                    ...
                    URL = BatchDeliveryService.BaseURL + "Batches/GetBatchesInformation?filter=" + "BatchNumber = \"" + batchNumber + "\"";
