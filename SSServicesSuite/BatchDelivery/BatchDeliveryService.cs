...
using System.ServiceModel;
 ...
 // sc \\HostName create BatchDelivery binpath= ExcutableFullFilePath DisplayName= "SSS Auto Import"
namespace BatchDelivery
{
    public partial class BatchDeliveryService : ServiceBase
    {
       
        private static NLog.Logger nlogger = LogManager.GetCurrentClassLogger();
        //public static string BaseURL = "http://localhost:47063" + "/api/";
        public static string BaseURL = BatchDelivery.Properties.Settings.Default["APIEndPointURL"].ToString(); 
        public static int SleepTime = Convert.ToInt32(BatchDelivery.Properties.Settings.Default["SleepTime"]);
        ...
        public BatchDeliveryService(string[] args)
        {
            InitializeComponent();
        }
        ...
        protected override void OnStart(string[] args)
        {
            try
            {
                ...
                BatchDelivery.Program.RunMultipleJobs().GetAwaiter().GetResult();
            }
