...
using System.ServiceModel;
 ...
 // sc \\HostName create AutoImport binpath= ExcutableFullFilePath DisplayName= "SSS Auto Import"
namespace AutoImport
{
    public partial class AutoImportService : ServiceBase
    {
       
        private static NLog.Logger nlogger = LogManager.GetCurrentClassLogger();
        //public static string BaseURL = "http://localhost:47063" + "/api/";
        public static string BaseURL = AutoImport.Properties.Settings.Default["APIEndPointURL"].ToString(); 
        public static int SleepTime = Convert.ToInt32(AutoImport.Properties.Settings.Default["SleepTime"]);
        ...
        public AutoImportService(string[] args)
        {
            InitializeComponent();
        }
        ...
        protected override void OnStart(string[] args)
        {
            try
            {
                ...
                AutoImport.Program.RunMultipleJobs().GetAwaiter().GetResult();
            }
