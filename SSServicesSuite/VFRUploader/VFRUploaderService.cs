...
using System.ServiceModel;
 ...
 // sc \\HostName create VFRUploader binpath= ExcutableFullFilePath DisplayName= "SSS Auto Import"
namespace VFRUploader
{
    public partial class VFRUploaderService : ServiceBase
    {
       
        private static NLog.Logger nlogger = LogManager.GetCurrentClassLogger();
        //public static string BaseURL = "http://localhost:47063" + "/api/";
        public static string BaseURL = VFRUploader.Properties.Settings.Default["APIEndPointURL"].ToString(); 
        public static int SleepTime = Convert.ToInt32(VFRUploader.Properties.Settings.Default["SleepTime"]);
        ...
        public VFRUploaderService(string[] args)
        {
            InitializeComponent();
        }
        ...
        protected override void OnStart(string[] args)
        {
            try
            {
                ...
                VFRUploader.Program.RunMultipleJobs().GetAwaiter().GetResult();
            }
