        ...
        public static ResultJobsExtended GetJobs()
        {
            ...
            try
            {
                lock (lockObj)
                {
                    ...
                    URL = SynchronizerService.BaseURL + "Jobs/GetJobs";
        ...
        public static ResultBatches GetBatches(string logJobName, string jobType, string statusFlag)
        {
            ...
            try
            {
                lock (lockObj)
                {
                    ...
                    HttpClient client = new HttpClient();
                    client.Timeout = TimeSpan.FromMinutes(15);
                    URL = SynchronizerService.BaseURL + "Batches/GetBatchesInformation?filter=" + "StatusFlag = \"" + statusFlag + "\" AND JobType = \"" + jobType + "\""; 
        ...
        public static ResultBatchDocs GetDocumentInformation(string logJobName, string batchName)
        {
            ...
            try
            {
                lock (lockObj)
                {
                    ...
                    HttpClient client = new HttpClient();
                    client.Timeout = TimeSpan.FromMinutes(15);
                    URL = SynchronizerService.BaseURL + "Batches/GetBatchDocsInformation?filter=" + "BatchName = \"" + batchName + "\"";
        ...
        public static ResultServiceStationsExtended GetServiceStations()
        {
            ...
            try
            {
                lock (lockObj)
                {
                    ...
                    HttpClient client = new HttpClient();
                    client.Timeout = TimeSpan.FromMinutes(15);
                    URL = SynchronizerService.BaseURL + "GeneralSettings/GetServiceStations";
        ...
        public static ResultJobsExtended GetJobByID(int jobID)
        {
            ...
            try
            {
                lock (lockObj)
                {
                    ...
                    HttpClient client = new HttpClient();
                    client.Timeout = TimeSpan.FromMinutes(15);
                    URL = SynchronizerService.BaseURL + "Jobs/GetJobByID?jobID=" + jobID.ToString();
        ...
        public static ResultProcesses GetProcessByName(string processName)
        {
            ...
            try
            {
                lock (lockObj)
                {
                    ...
                    HttpClient client = new HttpClient();
                    client.Timeout = TimeSpan.FromMinutes(15);
                    URL = SynchronizerService.BaseURL + "Process/GetProcessesByName?processName=" + processName;
        ...
        public static ResultFields GetFieldsByJobID(string logJobName, int jobID)
        {
            ...
            try
            {
                lock (lockObj)
                {
                    ...
                    HttpClient client = new HttpClient();
                    client.Timeout = TimeSpan.FromMinutes(15);
                    URL = SynchronizerService.BaseURL + "Fields/GetFieldsByJobID?jobID=" + jobID;
        ...
        public static ResultGeneric BatchTrackingEvent(string logJobName, string batchNumber, string currentStatus)
        {
            ...
            try
            {
                lock (lockObj)
                {
                    ...
                    batchTracking.FinalStatus = "Waiting for QC";
                    batchTracking.Event = "Makes Batch ready for QC";
                    batchTracking.OperatorName = "Synchronizer Service";
                    ...
                    URL = SynchronizerService.BaseURL + "Batches/NewBatchEvent";
        ...
        public static ResultGeneric NewBatchDocument(string logJobName, string batchNumber, BatchDocs batchDoc)
        {
            ...
            try
            {
                lock (lockObj)
                {
                    ...
                    URL = SynchronizerService.BaseURL + "Batches/NewBatchDocument";
        ...
        public static ResultGeneric BatchUpdate(string logJobName,Batch batch)
        {
            ...
            try
            {
                lock (lockObj)
                {
                    ...
                    URL = SynchronizerService.BaseURL + "Batches/UpdateBatchInformation";
        ...
        public static ResultGeneric DeleteBatchDocuments(string logJobName, string batchName)
        {
            ...
            try
            {
                lock (lockObj)
                {
                    ...
                    URL = SynchronizerService.BaseURL + "Batches/DeleteBatchDocuments";
        ...
        public static ResultBatches GetBatchesbyJobType(string logJobName, string jobType)
        {
            ...
            try
            {
                lock (lockObj)
                {
                    ...
                    URL = SynchronizerService.BaseURL + "Batches/GetBatchesInformation?filter=" + "JobType = \"" + jobType + "\"";
