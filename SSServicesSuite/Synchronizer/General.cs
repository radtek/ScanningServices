...
// To install this application as service: sc create SSS-Synchronizer binpath= "C:\Temp\ScanningServices\Services\Synchronizer\Synchronizer.exe" DisplayName= "SSS-Synchronizer" description= "Batch Synchronizer"  start= auto
// Add the description to the services: sc description <service name> "Batch Synchronizer"
// To remove the servies: sc.exe delete <service name>
