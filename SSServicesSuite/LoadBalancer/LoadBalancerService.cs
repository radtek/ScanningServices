...
using System.ServiceModel;
 ...
 // sc \\HostName create LoadBalancer binpath= ExcutableFullFilePath DisplayName= "SSS Auto Import"
namespace LoadBalancer
{
    public partial class LoadBalancerService : ServiceBase
    {
        ...
        public static string BaseURL = LoadBalancer.Properties.Settings.Default["APIEndPointURL"].ToString(); 
        public static int SleepTime = Convert.ToInt32(LoadBalancer.Properties.Settings.Default["SleepTime"]);
        ...
        public LoadBalancerService(string[] args)
        {
            InitializeComponent();
        }
        ...
        protected override void OnStart(string[] args)
        {
            try
            {
                ...
                LoadBalancer.Program.RunMultipleJobs().GetAwaiter().GetResult();
            }
