...
using System.ServiceModel;
 ...
 // sc \\HostName create VFRDuplicateRemover binpath= ExcutableFullFilePath DisplayName= "SSS Auto Import"
namespace VFRDuplicateRemover
{
    public partial class VFRDuplicateRemoverService : ServiceBase
    {
       
        private static NLog.Logger nlogger = LogManager.GetCurrentClassLogger();
        //public static string BaseURL = "http://localhost:47063" + "/api/";
        public static string BaseURL = VFRDuplicateRemover.Properties.Settings.Default["APIEndPointURL"].ToString(); 
        public static int SleepTime = Convert.ToInt32(VFRDuplicateRemover.Properties.Settings.Default["SleepTime"]);
        ...
        public VFRDuplicateRemoverService(string[] args)
        {
            InitializeComponent();
        }
        ...
        protected override void OnStart(string[] args)
        {
            try
            {
                ...
                VFRDuplicateRemover.Program.RunMultipleJobs().GetAwaiter().GetResult();
            }
