        ...
        public static ResultBatches GetBatches(string logJobName, string jobType, string statusFlag)
        {
            ...
            try
            {
                lock (lockObj)
                {
                    ...
                    HttpClient client = new HttpClient();
                    client.Timeout = TimeSpan.FromMinutes(15);
                    URL = VFRDuplicateRemoverService.BaseURL + "Batches/GetBatchesInformation?filter=" + "StatusFlag = \"" + statusFlag + "\" AND JobType = \"" + jobType + "\""; 
        ...
        public static ResultServiceStationsExtended GetServiceStations()
        {
            ...
            try
            {
                lock (lockObj)
                {
                    ...
                    HttpClient client = new HttpClient();
                    client.Timeout = TimeSpan.FromMinutes(15);
                    URL = VFRDuplicateRemoverService.BaseURL + "GeneralSettings/GetServiceStations";
        ...
        public static ResultJobsExtended GetJobByID(int jobID)
        {
            ...
            try
            {
                lock (lockObj)
                {
                    ...
                    HttpClient client = new HttpClient();
                    client.Timeout = TimeSpan.FromMinutes(15);
                    URL = VFRDuplicateRemoverService.BaseURL + "Jobs/GetJobByID?jobID=" + jobID.ToString();
        ...
        public static ResultProcesses GetProcessByName(string processName)
        {
            ...
            try
            {
                lock (lockObj)
                {
                    ...
                    HttpClient client = new HttpClient();
                    client.Timeout = TimeSpan.FromMinutes(15);
                    URL = VFRDuplicateRemoverService.BaseURL + "Process/GetProcessesByName?processName=" + processName;
        ...
        public static ResultGeneric BatchTrackingEvent(string logJobName, string batchNumber, string currentStatus)
        {
            ...
            try
            {
                lock (lockObj)
                {
                    ...
                    batchTracking.OperatorName = "VFRDuplicateRemover Service";
                    ...
                    URL = VFRDuplicateRemoverService.BaseURL + "Batches/NewBatchEvent";
        ...
        public static ResultGeneric BatchUpdate(string logJobName,Batch batch)
        {
            ...
            try
            {
                lock (lockObj)
                {
                    ...
                    URL = VFRDuplicateRemoverService.BaseURL + "Batches/UpdateBatchInformation";
        ...
        public static ResultGeneric DeleteBatchDocuments(string logJobName, string batchName)
        {
            ...
            try
            {
                lock (lockObj)
                {
                    ...
                    URL = VFRDuplicateRemoverService.BaseURL + "Batches/DeleteBatchDocuments";
