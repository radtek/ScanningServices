        ...
        public static ResultJobsExtended GetJobs(string logJobName)
        {
            ...
            try
            {
                lock (lockObj)                {
                    ...
                    URL = IndexingService.BaseURL + "Jobs/GetJobs";
        ...
        public static ResultJobPageSizes GetPageSizesByJobID(string logJobName, int jobID)
        {
            ...
            try
            {
                lock (lockObj)
                {
                    ...
                    HttpClient client = new HttpClient();
                    client.Timeout = TimeSpan.FromMinutes(15);
                    URL = IndexingService.BaseURL + "Jobs/GetPageSizesByJobID?jobID=" + jobID.ToString();
        ...
        public static ResultBatches GetBatches(string logJobName, string jobType, string statusFlag)
        {
            ...
            try
            {
                lock (lockObj)
                {
                    ...
                    HttpClient client = new HttpClient();
                    client.Timeout = TimeSpan.FromMinutes(15);
                    URL = IndexingService.BaseURL + "Batches/GetBatchesInformation?filter=" + "StatusFlag = \"" + statusFlag + "\" AND JobType = \"" + jobType + "\""; 
        ...
        public static ResultBatchDocs GetDocumentInformation(string logJobName, string batchName)
        {
            ...
            try
            {
                lock (lockObj)
                {
                    ...
                    HttpClient client = new HttpClient();
                    client.Timeout = TimeSpan.FromMinutes(15);
                    URL = IndexingService.BaseURL + "Batches/GetBatchDocsInformation?filter=" + "BatchName = \"" + batchName + "\"";
        ...
        public static ResultServiceStationsExtended GetServiceStations(string logJobName)
        {
            ...
            try
            {
                lock (lockObj)
                {
                    ...
                    HttpClient client = new HttpClient();
                    client.Timeout = TimeSpan.FromMinutes(15);
                    URL = IndexingService.BaseURL + "GeneralSettings/GetServiceStations";
        ...
        public static ResultJobsExtended GetJobByID(string logJobName,int jobID)
        {
            ...
            try
            {
                lock (lockObj)
                {
                    ...
                    HttpClient client = new HttpClient();
                    client.Timeout = TimeSpan.FromMinutes(15);
                    URL = IndexingService.BaseURL + "Jobs/GetJobByID?jobID=" + jobID.ToString();
        ...
        public static ResultProcesses GetProcessByName(string logJobName, string processName)
        {
            ...
            try
            {
                lock (lockObj)
                {
                    ...
                    HttpClient client = new HttpClient();
                    client.Timeout = TimeSpan.FromMinutes(15);
                    URL = IndexingService.BaseURL + "Process/GetProcessesByName?processName=" + processName;
        ...
        public static ResultFields GetFieldsByJobID(string logJobName, int jobID)
        {
            ...
            try
            {
                lock (lockObj)
                {
                    ...
                    HttpClient client = new HttpClient();
                    client.Timeout = TimeSpan.FromMinutes(15);
                    URL = IndexingService.BaseURL + "Fields/GetFieldsByJobID?jobID=" + jobID;
        ...
        public static ResultBatches GetBatchesbyJobType(string logJobName, string jobType)
        {
            ...
            try
            {
                lock (lockObj)
                {
                    ...
                    URL = IndexingService.BaseURL + "Batches/GetBatchesInformation?filter=" + "JobType = \"" + jobType + "\"";
        ...
        public static ResultGeneric BatchTrackingEvent(string logJobName, string batchNumber, string currentStatus)
        {
            ...
            try
            {
                lock (lockObj)
                {
                    ...
                    batchTracking.OperatorName = "Indexing Service";
                    ...
                    URL = IndexingService.BaseURL + "Batches/NewBatchEvent";
        ...
        public static ResultGeneric BatchUpdate(string logJobName,Batch batch)
        {
            ...
            try
            {
                lock (lockObj)
                {
                    ...
                    URL = IndexingService.BaseURL + "Batches/UpdateBatchInformation";
        ...
        public static ResultGeneric DeleteBatchDocuments(string logJobName, string batchName)
        {
            ...
            try
            {
                lock (lockObj)
                {
                    ...
                    URL = IndexingService.BaseURL + "Batches/DeleteBatchDocuments";
