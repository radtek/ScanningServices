...
using System.ServiceModel;
 ...
 // sc \\HostName create Indexing binpath= ExcutableFullFilePath DisplayName= "SSS Auto Import"
namespace Indexing
{
    public partial class IndexingService : ServiceBase
    {
        ...
        public static string BaseURL = Indexing.Properties.Settings.Default["APIEndPointURL"].ToString(); 
        public static int SleepTime = Convert.ToInt32(Indexing.Properties.Settings.Default["SleepTime"]);
        ...
        public IndexingService(string[] args)
        {
            InitializeComponent();
        }
            ...
            try
            {
                lock (lockObj)
                {
                   ...
                   // Console.WriteLine("Entering into Service OnStart");
                    ...
                    Indexing.Program.RunMultipleJobs().GetAwaiter().GetResult();
                }                
            }
