...
namespace Reporting
{
    public partial class ReportingService : ServiceBase
    {
        ...
        public static string BaseURL = Reporting.Settings.Default["APIEndPointURL"].ToString(); //"http://localhost:47063" + "/api/";
        public static int SleepTime = Convert.ToInt32(Reporting.Settings.Default["SleepTime"]);
        ...
        // jobProcesses List wil lbe used to keep track of runing cron Jobs
        public static List<ReportProcess> reportProcesses = new List<ReportProcess>();
        ...
        public ReportingService(string[] args)
        {
        ...
        protected override void OnStart(string[] args)
        {
            try
            {
                ...
                // Start Cron Jobs
                Reporting.Program.RunMultipleJobs().GetAwaiter().GetResult();                
            }
